...
package protobuf.AggregateSensorData

/** Represents a sales record
 */
@SerialVersionUID(0L)
final case class AggregateSensorData(
                                        ...
                                        ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AggregateSensorData] {
  @transient
  ...
  def withSensorId(__v: _root_.scala.Int): AggregateSensorData = copy(sensorId = __v)
  def withAverageTemperature(__v: _root_.scala.Float): AggregateSensorData = copy(averageTemperature = __v)
  def withAverageHumidity(__v: _root_.scala.Float): AggregateSensorData = copy(averageHumidity = __v)
  def withMinimumTemperature(__v: _root_.scala.Float): AggregateSensorData = copy(minimumTemperature = __v)
  def withMaximumTemperature(__v: _root_.scala.Float): AggregateSensorData = copy(maximumTemperature = __v)
  def withMinimumHumidity(__v: _root_.scala.Float): AggregateSensorData = copy(minimumHumidity = __v)
  def withMaximumHumidity(__v: _root_.scala.Float): AggregateSensorData = copy(maximumHumidity = __v)
  def withNoOfRecords(__v: _root_.scala.Long): AggregateSensorData = copy(noOfRecords = __v)
  ...
  def companion: protobuf.AggregateSensorData.AggregateSensorData.type = protobuf.AggregateSensorData.AggregateSensorData
  // @@protoc_insertion_point(GeneratedMessage[protobuf.AggregateSensorData])
}

object AggregateSensorData extends scalapb.GeneratedMessageCompanion[protobuf.AggregateSensorData.AggregateSensorData] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[protobuf.AggregateSensorData.AggregateSensorData] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): protobuf.AggregateSensorData.AggregateSensorData = {
    ...
    protobuf.AggregateSensorData.AggregateSensorData(
      sensorId = __sensorId,
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[protobuf.AggregateSensorData.AggregateSensorData] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AggregateSensorDataProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AggregateSensorDataProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = protobuf.AggregateSensorData.AggregateSensorData(
    sensorId = 0,
  ...
  implicit class AggregateSensorDataLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, protobuf.AggregateSensorData.AggregateSensorData]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, protobuf.AggregateSensorData.AggregateSensorData](_l) {
  ...
  def of(
        ...
        ): _root_.protobuf.AggregateSensorData.AggregateSensorData = _root_.protobuf.AggregateSensorData.AggregateSensorData(
    sensorId,
    averageTemperature,
    averageHumidity,
    minimumTemperature,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[protobuf.AggregateSensorData])
}
...
final case class SensorData(
                              ...
                              ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SensorData] {
  @transient
  ...
  def withSensorId(__v: _root_.scala.Int): SensorData = copy(sensorId = __v)
  def withTimestamp(__v: _root_.scala.Long): SensorData = copy(timestamp = __v)
  def withTemperature(__v: _root_.scala.Float): SensorData = copy(temperature = __v)
  def withHumidity(__v: _root_.scala.Float): SensorData = copy(humidity = __v)
  ...
  def companion: protobuf.SensorData.SensorData.type = protobuf.SensorData.SensorData
  // @@protoc_insertion_point(GeneratedMessage[protobuf.SensorData])
}

object SensorData extends scalapb.GeneratedMessageCompanion[protobuf.SensorData.SensorData] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[protobuf.SensorData.SensorData] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): protobuf.SensorData.SensorData = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[protobuf.SensorData.SensorData] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SensorDataProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SensorDataProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = protobuf.SensorData.SensorData(
    sensorId = 0,
    timestamp = 0L,
    temperature = 0.0f,
    humidity = 0.0f
  )
  implicit class SensorDataLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, protobuf.SensorData.SensorData]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, protobuf.SensorData.SensorData](_l) {
  ...
  def of(
        ...
        ): _root_.protobuf.SensorData.SensorData = _root_.protobuf.SensorData.SensorData(
    sensorId,
    timestamp,
    temperature,
    humidity
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[protobuf.SensorData])
}